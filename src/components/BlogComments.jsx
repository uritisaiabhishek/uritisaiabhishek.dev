          ...
          <div className="media border-bottom py-4">
            ...
            <div className="media-body">
              ...
              <p>Ne erat velit invidunt his. Eum in dicta veniam interesset, harum fuisset te nam ea cu lupta
                definitionem.</p>
              <a href="#!" className="btn btn-transparent btn-sm pl-0">Reply</a>
        ...
        <div className="mt-5">
          ...
          <form action="#" className="row">
            <div className="col-md-6">
              <input type="text" className="form-control mb-3" placeholder="First Name" name="fname" id="fname"  />
              <input type="text" className="form-control mb-3" placeholder="Last Name" name="lname" id="lname"  />
              <input type="text" className="form-control mb-3" placeholder="Email *" name="mail" id="mail"  />
            </div>
            <div className="col-md-6">
