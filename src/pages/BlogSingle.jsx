...
function BlogSingle() {
  return (
    <>
      <PageTitle title="Post title comes here" />
      
<section className="section">
  <div className="container">
    <div className="row">
      <div className="col-lg-12">
        <h3 className="font-tertiary mb-3">What should be the proper purpose of UI and UX design?</h3>
        <p className="font-secondary mb-5">Published on May 26, 2017 by <span className="text-primary">uixgeek</span>
           on <span>UX design</span></p>
        <div className="content">
          <img src="/images/blog/post-1.jpg" alt="post-thumb" className="img-fluid rounded float-left mr-5 mb-4" />
